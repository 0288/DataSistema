 ...
 * @author DELL
 */
public class GestionarEquipos1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane_equipos, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 580, 130));
        ...
        getContentPane().add(cmb_estatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 70, 120, -1));

        jButton_mostrar.setBackground(new java.awt.Color(153, 153, 255));
        jButton_mostrar.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        getContentPane().add(jButton_mostrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 230, 170, 40));
        getContentPane().add(jLabel_Wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 700, 320));
    ...
    private void jButton_mostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_mostrarActionPerformed
        ...
        try {
            ...
            if(seleccion.equalsIgnoreCase("Todos")){
                query = "select id_equipo, tipo_equipo, marca, estatus, estatus from equipos";
            
            }else{
                query = "select id_equipo, tipo_equipo, marca, estatus, estatus from equipos where estatus = '" + seleccion + "'";
           ...
           cn.close();
            ...
            System.err.println("Error al recuperar registro de equipos" + e);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionarEquipos1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionarEquipos1().setVisible(true);
            }
        });
    }
