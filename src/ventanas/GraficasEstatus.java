 ...
 * @author DELL
 */
public class GraficasEstatus extends javax.swing.JFrame {
    ...
    /**
     * Creates new form GraficasEstatus
     */
    public GraficasEstatus() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel_Wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 543, 443));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GraficasEstatus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GraficasEstatus().setVisible(true);
            }
        });
    }
