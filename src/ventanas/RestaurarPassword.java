...
public class RestaurarPassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txt_password, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 200, 20));

        txt_passwordConfirmacion.setBackground(new java.awt.Color(153, 153, 255));
        txt_passwordConfirmacion.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        ...
        getContentPane().add(txt_passwordConfirmacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, 200, 20));
        ...
        jButton_restaurarpassword.setText("Restaurar");
        ...
        getContentPane().add(jButton_restaurarpassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 150, 170, 40));
        getContentPane().add(jLabel_Wallpaper, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 400, 380));
...
if (!password.equals("") && !confirmacion_password.equals("")){
    ...
    JOptionPane.showMessageDialog(null, "No se aseptan contraseñas vacias.");
