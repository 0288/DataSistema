...
public class Tecnico extends javax.swing.JFrame {
    ...
    public Tecnico() {
        ...
        try {
            ...
            System.out.println("error en conexion nombre de Tecnico.");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton_GestionarEquipos, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 70, 90, 80));
        ...
        getContentPane().add(jButton_GraficaEstatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 70, 90, 80));
        ...
        getContentPane().add(jButton_GraficaMarcas, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 70, 90, 80));
    ...
    private void jButton_GraficaEstatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GraficaEstatusActionPerformed
        ...
        GraficasEstatus graficarEstatus = new GraficasEstatus();
    ...
    private void jButton_GestionarEquiposActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GestionarEquiposActionPerformed
        ...
        GestionarEquipos1 gestionarEquipos = new GestionarEquipos1();
